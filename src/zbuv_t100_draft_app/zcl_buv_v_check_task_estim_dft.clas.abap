CLASS zcl_buv_v_check_task_estim_dft DEFINITION
  PUBLIC
...
CLASS zcl_buv_v_check_task_estim_dft IMPLEMENTATION.
  ...
  METHOD /bobf/if_frw_validation~execute.
    ...
    eo_message->add_message(
      EXPORTING is_msg       = VALUE #(
                ...
                iv_node       = is_ctx-node_key
                iv_key        = ls_task-key
                iv_attribute  = zif_buv_i_projectdraft_tp_c=>sc_node_attribute-zbuv_i_taskdraft_tp-taskestimation
