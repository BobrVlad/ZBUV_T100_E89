CLASS zcl_buv_a_complete_project DEFINITION
  PUBLIC
...
CLASS zcl_buv_a_complete_project IMPLEMENTATION.


  METHOD /bobf/if_frw_action~execute.

    CONSTANTS status_done TYPE zbuv_status VALUE 'DN'.
    DATA lr_project TYPE REF TO zsbuv_i_projectactive_tp.
      ...
      io_modify->update(
        EXPORTING
          ...
          it_changed_fields = VALUE #(
            ( zif_buv_i_projectactive_tp_c=>sc_node_attribute-zbuv_i_projectactive_tp-projectstatus ) ) ).
