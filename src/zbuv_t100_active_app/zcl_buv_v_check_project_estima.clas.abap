CLASS zcl_buv_v_check_project_estima DEFINITION
  PUBLIC
...
CLASS zcl_buv_v_check_project_estima IMPLEMENTATION.
  ...
  METHOD /bobf/if_frw_validation~execute.
    ...
    eo_message->add_message(
      EXPORTING is_msg       = VALUE #(
                ...
                iv_attribute  = zif_buv_i_projectactive_tp_c=>sc_node_attribute-zbuv_i_projectactive_tp-projectestimation
